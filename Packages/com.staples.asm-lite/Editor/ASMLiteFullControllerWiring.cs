...
{
    internal readonly struct ASMLiteFullControllerReferenceSnapshot
    {
        internal ASMLiteFullControllerReferenceSnapshot(string controllerAssetPath, string menuAssetPath, string parametersAssetPath)
        {
    ...
    /// <summary>
    /// Centralizes VRCFury FullController reflection, serialized-property access,
    /// live repair, retargeting, and reference capture for ASM-Lite editor flows.
    /// </summary>
    internal static class ASMLiteFullControllerWiring
    {
        ...
        internal static ASMLiteBuildDiagnosticResult TryRefreshLiveFullControllerWiringWithDiagnostics(GameObject root, ASMLiteComponent component, string contextLabel)
        {
            ...
            ConfigurePrefabRoot(root, component);
        ...
        internal static ASMLiteBuildDiagnosticResult TryWirePackageGeneratedAssetsWithDiagnostics(ASMLiteComponent component, string contextLabel)
        {
            if (component == null)
            {
                return ASMLiteBuildDiagnosticResult.Fail(
            ...
            if (!ASMLiteBuilder.TryRepairPackageGeneratedFxControllerIfCorrupt(contextLabel + " FullController Wiring"))
            {
                return ASMLiteBuildDiagnosticResult.Fail(
                    code: ASMLiteDiagnosticCodes.Build.FullControllerWiringFailed,
                    contextPath: ASMLiteAssetPaths.FXController,
            ...
            if (vfComponent == null)
            {
                var refreshResult = TryRefreshLiveFullControllerWiringWithDiagnostics(
        ...
        {
            var vfComponent = component != null ? FindLiveVrcFuryComponent(component.gameObject) : null;
            if (vfComponent == null)
                return false;
        ...
        {
            return component != null && FindLiveVrcFuryComponent(component.gameObject) != null;
        }

        internal static ASMLiteBuildDiagnosticResult TrySyncLiveMenuPrefixWithDiagnostics(ASMLiteComponent component)
        {
            if (component == null)
            {
                return ASMLiteBuildDiagnosticResult.Fail(
            ...
            out ASMLiteFullControllerReferenceSnapshot snapshot)
        {
            ...
            snapshot = new ASMLiteFullControllerReferenceSnapshot(
        ...
        internal static void ConfigurePrefabRoot(GameObject root, ASMLiteComponent component)
        {
            if (root == null)
                return;
